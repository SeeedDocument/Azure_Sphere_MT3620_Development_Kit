...
void* Grove4DigitDisplay_Open(GPIO_Id pin1Id, GPIO_Id pin2Id)
{
	...
	this->ClkFd = GPIO_OpenAsOutput(pin1Id, GPIO_OutputMode_PushPull, GPIO_Value_High);
	this->DioFd = GPIO_OpenAsOutput(pin2Id, GPIO_OutputMode_OpenDrain, GPIO_Value_High);
	usleep(1);
